...
add wave -noupdate -expand -group staller /I3C_TOP_TB/DUT/u_scl_staller/o_stall_done
add wave -noupdate -expand -group staller /I3C_TOP_TB/DUT/u_scl_staller/o_scl_stall
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {10782520706 ps} 0} {{Cursor 4} {3385000000 ps} 0}
...
update
WaveRestoreZoom {2637711206 ps} {4129900390 ps}
