...
add wave -noupdate /I3C_TOP_TB/DUT/CCC_Handler/i_i_regf_TOC
add wave -noupdate /I3C_TOP_TB/RAND_INDEX
add wave -noupdate /I3C_TOP_TB/tmp_regf_read_words
add wave -noupdate -expand -group CCC -radix unsigned /I3C_TOP_TB/DUT/CCC_Handler/current_state
add wave -noupdate -expand -group CCC -color {Orange Red} -itemcolor {Orange Red} /I3C_TOP_TB/DUT/RX/o_ddrccc_error
add wave -noupdate -expand -group CCC /I3C_TOP_TB/DUT/CCC_Handler/o_regf_ERR_STATUS
...
add wave -noupdate /I3C_TOP_TB/DUT/CCC_Handler/o_engine_done
add wave -noupdate -height 30 -group Rxxx /I3C_TOP_TB/DUT/RX/byte_num
add wave -noupdate -height 30 -group Rxxx /I3C_TOP_TB/DUT/RX/parity_value_temp
add wave -noupdate -height 30 -group Rxxx -expand /I3C_TOP_TB/DUT/RX/parity_value_calc
add wave -noupdate -height 30 -group Rxxx -radix binary /I3C_TOP_TB/DUT/RX/o_regfcrc_rx_data_out_temp
add wave -noupdate -height 30 -group Rxxx /I3C_TOP_TB/DUT/RX/count_done
add wave -noupdate -height 30 -group Rxxx -radix unsigned /I3C_TOP_TB/DUT/RX/count
...
WaveRestoreCursors {{Cursor 4} {64969297178086 ps} 0}
...
update
WaveRestoreZoom {64968998197463 ps} {64971284305397 ps}
