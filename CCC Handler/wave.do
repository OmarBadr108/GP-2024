...
add wave -noupdate -height 30 -expand -group Staller /CCC_Handler_tb/o_sclstall_en_tb
add wave -noupdate -height 30 -expand -group Staller /CCC_Handler_tb/i_stall_cycles
add wave -noupdate -height 30 -expand -group Staller /CCC_Handler_tb/i_sclstall_stall_done_tb
...
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/o_crc_parallel_data_tx_tb
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/o_crc_last_byte_tx_tb
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/o_crc_last_byte_rx_tb
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/o_crc_en_tb
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/o_crc_data_valid_tx_tb
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/o_crc_data_valid_rx_tb
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/i_crc_value_tb
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/i_crc_valid_tb
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/en_mux
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/crc_en_tx
add wave -noupdate -height 30 -expand -group CRC /CCC_Handler_tb/crc_en_rx
...
add wave -noupdate -height 30 -expand -group RX -radix unsigned /CCC_Handler_tb/o_rx_mode_tb
add wave -noupdate -height 30 -expand -group RX /CCC_Handler_tb/o_rx_en_tb
add wave -noupdate -height 30 -expand -group RX /CCC_Handler_tb/i_rx_pre_tb
add wave -noupdate -height 30 -expand -group RX /CCC_Handler_tb/i_rx_mode_done_tb
add wave -noupdate -height 30 -expand -group RX /CCC_Handler_tb/i_rx_error_tb
add wave -noupdate -height 30 -expand -group Tx /CCC_Handler_tb/i_tx_mode_done_tb
add wave -noupdate -height 30 -expand -group Tx -radix unsigned /CCC_Handler_tb/o_tx_mode_tb
add wave -noupdate -height 30 -expand -group Tx /CCC_Handler_tb/o_tx_en_tb
...
WaveRestoreCursors {{Cursor 1} {1288 ns} 0}
...
update
WaveRestoreZoom {568 ns} {2152 ns}
