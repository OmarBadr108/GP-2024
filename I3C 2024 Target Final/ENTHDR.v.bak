       ...
       begin
        ...
        case(state)
           ...
           ACK:         
            ...
            o_regf_addr         <= 'd50;
            o_regf_rd_en        <=  1'b1;
             if(!i_rx_ack_nack && i_rx_mode_done ) //if ACK next state is ENTHDR_DDR  //&& i_scl_neg_edge
               begin
                 state               <= ENTHDR_DDR;
                 o_regf_rd_en        <= 1'b1;  
            ...
            begin
             if(i_tx_mode_done && i_scl_neg_edge)     // ****(scl neg edge condition check)
               begin
                 ...
                 //o_i3cengine_done <= 1'b1; //editttttttttt
               end
             else
               begin
                 state               <= ENTHDR_DDR;
