...
add wave -noupdate -height 24 -group ENTHDR /I3C_TOP_TB/DUT/u_enthdr/o_regf_addr
...
add wave -noupdate -height 24 -group I3C_ENGINE /I3C_TOP_TB/DUT/u_i3c_engine/state
...
WaveRestoreCursors {{Cursor 1} {3405602528 ps} 0}
...
update
WaveRestoreZoom {1616198275 ps} {1989245571 ps}
