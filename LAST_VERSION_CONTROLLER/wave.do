...
add wave -noupdate -color Gold -itemcolor Gold /I3C_TOP_TB/scl_tb
add wave -noupdate -color Cyan -itemcolor Cyan /I3C_TOP_TB/sda_tb
...
add wave -noupdate -expand -group CCC /I3C_TOP_TB/DUT/RX/o_ddrccc_error
...
add wave -noupdate -height 30 -expand -group Rxxx /I3C_TOP_TB/DUT/RX/badr_flag
add wave -noupdate -height 30 -expand -group Rxxx /I3C_TOP_TB/DUT/RX/badr_flag_2
add wave -noupdate -height 30 -expand -group Rxxx /I3C_TOP_TB/DUT/RX/byte_num
add wave -noupdate -height 30 -expand -group Rxxx /I3C_TOP_TB/DUT/RX/parity_value_temp
add wave -noupdate -height 30 -expand -group Rxxx -expand /I3C_TOP_TB/DUT/RX/parity_value_calc
add wave -noupdate -height 30 -expand -group Rxxx -radix binary /I3C_TOP_TB/DUT/RX/o_regfcrc_rx_data_out_temp
add wave -noupdate -height 30 -expand -group Rxxx /I3C_TOP_TB/DUT/RX/count_done
add wave -noupdate -height 30 -expand -group Rxxx -radix unsigned /I3C_TOP_TB/DUT/RX/count
add wave -noupdate -group Configuration -color {Violet Red} -itemcolor {Violet Red} /I3C_TOP_TB/DUT/CCC_Handler/i_i_regf_TOC
...
add wave -noupdate -group Configuration /I3C_TOP_TB/DUT/u_hdr_engine/i_CP
add wave -noupdate -group Configuration /I3C_TOP_TB/DUT/CCC_Handler/i_i_regf_DTT
add wave -noupdate -group Configuration /I3C_TOP_TB/DUT/u_reg_file/o_engine_MODE
add wave -noupdate -group Configuration /I3C_TOP_TB/DUT/CCC_Handler/i_i_regf_RnW
add wave -noupdate -group Configuration /I3C_TOP_TB/DUT/frame_counter_hdr/i_regf_DATA_LEN
add wave -noupdate -group Configuration /I3C_TOP_TB/DUT/CCC_Handler/i_i_regf_DBP
...
add wave -noupdate -expand /I3C_TOP_TB/DUT/RX/parity_value_temp
...
WaveRestoreCursors {{Cursor 4} {87552394352 ps} 0}
...
update
WaveRestoreZoom {88081225892 ps} {88974672322 ps}
